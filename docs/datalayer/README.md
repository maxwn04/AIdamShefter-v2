...
**Status:** Implementation in progress; see [`status.md`](status.md)
...
| [`status.md`](status.md) | Current PR-stack state, gates, and blockers |
| [`log.md`](log.md) | Chronological implementation decisions and verification evidence |
