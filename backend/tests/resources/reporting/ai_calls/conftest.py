"""Disposable PostgreSQL fixtures for AI-call resource tests."""
...
def clean_ai_call_resources(request: pytest.FixtureRequest) -> None:
...
def generation_domain(database_engine) -> GenerationDomain:
    return seed_generation_domain(database_engine, label="AI Call Resource")
